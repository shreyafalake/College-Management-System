...
const UpdateStudent=()=>{
    useEffect(()=>{
        document.title="UPDATE Student ||Learn code with Shreya";
    },[]);
    ...
    return(
        <Fragment>
            <h1 className="text-center my-3 border border-danger">Fill the Updated Student Details</h1>
            ...
            <FormGroup>
            <b><label for="description">Student Division</label></b>
                <Input
                    Type="textarea"
